<template>
    <footer class="footer footer-center p-10 bg-primary text-primary-content fixed bottom-0  sm:bottom-0">
  <div>
    ...
    <p class="font-bold">
      MoussaCorp Industries Ltd. <br/>Providing reliable tech since 2023
    </p> 
